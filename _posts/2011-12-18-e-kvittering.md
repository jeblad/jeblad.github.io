...
{% figure caption:"Lenke til kvitteringen i form av en QR-kode" class:"right_aligned" %}
  [![En QR-kode for maskinlesing; Denne lenker ut til et eksternt nettsted, som angitt i eksempelet.](/assets/images/receipt/receipt-qr-code_98x450.png "Lenke til kvitteringen i form av en QR-kode")](/assets/images/receipt/receipt-qr-code_1024x1024.png)
{% endfigure %}
